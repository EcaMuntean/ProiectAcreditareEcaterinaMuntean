...
public class Constants {
    ...
    public static final String LASTNAME ="Ecaterina";
    public static final String ADDRESS ="str.Fabricii, nr.88";
    ...
    public static final String NEW_USER_EMAIL = "eca@muntean.com";
    public static final String NEW_USERNAME = "eca";
    public static final String CURRENT_PASS = "Parola1234!";
    public static final String NEW_PASS = "Parola12345!";
    public static final String COUPON_CODE = "10ron";
